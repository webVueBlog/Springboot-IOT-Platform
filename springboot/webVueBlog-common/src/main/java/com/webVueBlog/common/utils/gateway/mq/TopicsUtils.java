...
import com.webVueBlog.common.utils.collection.CollectionUtils;
...
public class TopicsUtils {
    ...
    public String buildTopic(Long productId, String serialNumber, TopicType type) {
        ...
        if (com.webVueBlog.common.utils.StringUtils.isEmpty(serialNumber)) {
            serialNumber = "+";
        }
        if (type.getType() == 0) {
            return enabled ? "/" + product + "/" + serialNumber + type.getTopicSuffix() : DaConstant.MQTT.PREDIX + type.getTopicSuffix();
        } else {
    ...
    public String topicSubDevice(String orgTopic, Long productId, String serialNumber) {
        if (com.webVueBlog.common.utils.StringUtils.isEmpty(orgTopic)) {
            return orgTopic;
        }
    ...
    public static boolean validTopicFilter(List<String> topicNameList) {
        for (String topicName : topicNameList) {
            if (com.webVueBlog.common.utils.StringUtils.isEmpty(topicName)) {
                return false;
            }

...
import com.webVueBlog.common.utils.file.MimeTypeUtils;
import com.webVueBlog.framework.web.service.TokenService;
import com.webVueBlog.iot.domain.UserSocialProfile;
import com.webVueBlog.iot.service.IUserSocialProfileService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(DaConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);

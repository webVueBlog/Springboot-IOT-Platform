...
public class PubMqttClient {
    ...
    public final String getClientId() {
        return DaConstant.SERVER.WM_PREFIX + System.currentTimeMillis();
    }
    ...
    public void publish(String topic, byte[] pushMessage, FunctionLog log) {
        try {
            redisCache.incr2(DaConstant.REDIS.MESSAGE_SEND_TOTAL, -1L);
            redisCache.incr2(DaConstant.REDIS.MESSAGE_SEND_TODAY, 60 * 60 * 24);

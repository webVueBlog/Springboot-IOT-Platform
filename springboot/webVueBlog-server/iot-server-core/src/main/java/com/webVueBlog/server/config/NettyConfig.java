package com.webVueBlog.server.config;
...
import com.webVueBlog.server.TCPServer;
import com.webVueBlog.server.UDPServer;
import com.webVueBlog.base.codec.Delimiter;
import com.webVueBlog.base.codec.LengthField;
...
public class NettyConfig {
    ...
    public NettyConfig(int workerGroup,
        ...
        /*校验值是否正确*/
        ObjectUtil.checkNotNull(port, DaConstant.SERVER.PORT);
        ObjectUtil.checkPositive(port, DaConstant.SERVER.PORT);
        ...
        if (type == ServerType.TCP){
            ObjectUtil.checkNotNull(maxFrameLength, DaConstant.SERVER.MAXFRAMELENGTH);
            ObjectUtil.checkPositive(maxFrameLength, DaConstant.SERVER.MAXFRAMELENGTH);
            // ObjectUtil.checkNotNull(delimiters,DaConstant.SERVER.DELIMITERS);

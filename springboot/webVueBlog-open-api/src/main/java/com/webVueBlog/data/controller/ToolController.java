...
import com.webVueBlog.common.ProtocolDeCodeService;
...
import com.webVueBlog.common.exception.file.FileNameLengthLimitExceededException;
import com.webVueBlog.common.utils.StringUtils;
import com.webVueBlog.common.utils.file.FileUploadUtils;
...
import com.webVueBlog.iot.model.*;
...
import com.webVueBlog.iot.util.VelocityInitializer;
import com.webVueBlog.iot.util.VelocityUtils;
...
import static com.webVueBlog.common.utils.file.FileUploadUtils.getExtension;
...
public class ToolController extends BaseController {
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            String filePath = DaConfig.getProfile();
            // 文件名长度限制
...
//            }
    ...
    private void genSdk(HttpServletResponse response, byte[] data) throws IOException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"webVueBlog.zip\"");
